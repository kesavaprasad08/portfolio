      ...
      <div className="w-9/12  bg-navGreen rounded shadow p-8 flex flex-col lg:flex-row flex-wrap justify-between">
        ...
        />
          ...
          <div className="flex flex-row mt-2 mb-6 flex-wrap lg:flex-row">
            ...
            <p className="bg-blue-500 p-2 mt-2 rounded-2xl text-xs ml-2">Bootstrap</p>
            <p className="bg-blue-500 p-2 mt-2 rounded-2xl text-xs ml-2">Redux</p>
            <p className="bg-blue-500 p-2 mt-2 rounded-2xl text-xs ml-2">Firebase</p>            
            <p className="bg-blue-500 p-2 mt-2 rounded-2xl text-xs ml-2">Custom Hooks</p>
            <p className="bg-blue-500 p-2 mt-2 rounded-2xl text-xs ml-2">React-Router</p>     
            <p className="bg-blue-500 p-2 mt-2 rounded-2xl text-xs ml-2">Github</p>
          </div>
      ...
      <div className=" w-9/12  bg-navGreen rounded shadow p-5 flex flex-col lg:flex-row flex-wrap justify-between mt-5">
        ...
        />
          ...
          <div className="mt-2">
            ...
            <a href="https://github.com/kesavaprasad08/Expense-Tracker-final" target="_blank" rel="noopener noreferrer"  className="lg:p-2 pl-2">
              <button className="bg-green-500 p-2 hover:bg-green-300 rounded">
                Github Repository
              </button>
            </a>
