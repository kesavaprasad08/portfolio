const Home = () => {
  return (
    <section
      className=" flex flex-col lg:flex-row   items-center bg-pageGreen  p-10 text-white pt-14 lg:h-screen "
      id="Home"
    >
      ...
      <div>
        <a href="#portfolio" className="lg:p-2">
          <button className="bg-green-500 p-2 hover:bg-green-300 ">View My Works</button>
        </a>
        <a href="#portfolio" className="lg:p-2 pl-2">
          <button className="bg-green-500 p-2 hover:bg-green-300">My Resume</button>
        </a>
        </div>
      </div>
      <img
